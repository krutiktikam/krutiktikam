...
| **[PokéMarket]([https://github.com/krutiktikam/Poke-stocks](https://github.com/krutiktikam/poke-hodl))** | Institutional-grade trading terminal featuring a Gemini Vision AI card scanning pipeline and 30-day linear regression price projections. | `Next.js 15` `TypeScript` `Gemini Vision AI` `Supabase` `Recharts` |
